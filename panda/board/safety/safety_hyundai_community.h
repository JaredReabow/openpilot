...
static int hyundai_community_fwd_hook(int bus_num, CAN_FIFOMailBox_TypeDef *to_fwd) {
  ...
  if ((HKG_forward_bus1 || HKG_forward_obd) && (addr == 688 ||addr == 608 || addr == 1136 || addr == 870 || addr == 1265 || addr == 915 || addr == 399 || addr == 356 || addr == 608 || addr == 1345 || addr == 832 || addr == 544 || addr == 273 || addr == 1292)){fwd_to_bus1 = 1;} //MDPS SPAS
